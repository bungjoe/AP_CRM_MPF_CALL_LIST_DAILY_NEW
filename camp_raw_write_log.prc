...
/******** oRBP *************/
  ...
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_CALL_LIST_FINAL');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_CALL_LIST_FINAL
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_CALL_LIST_FINAL LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_CALL_LIST_FINAL');
  
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_TDY_CALL_LIST');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_TDY_CALL_LIST
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_TDY_CALL_LIST LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_TDY_CALL_LIST');
  
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_ELIG_BASE');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_ELIG_BASE
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_ELIG_BASE LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_ELIG_BASE');
  
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_DAILY_CHECK');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_DAILY_CHECK
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_DAILY_CHECK LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_DAILY_CHECK');
  
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_OFFER');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_OFFER
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_OFFER LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_OFFER');
  
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_COMPILED_LIST');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_COMPILED_LIST
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_COMPILED_LIST LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_COMPILED_LIST');
  
  AP_PUBLIC.CORE_LOG_PKG.pStart('Ins:LOG_CAMP_ORBP_PRE_COMP');
  insert /*+ APPEND */ into AP_CRM.LOG_CAMP_ORBP_PRE_COMP
  SELECT TRUNC(SYSDATE) LOG_DATE, TO_CHAR(SYSDATE, 'hh24:mi:ss') TIME_INSERTED, LOG.* FROM CAMP_ORBP_PRE_COMP LOG;
  AP_PUBLIC.CORE_LOG_PKG.pEnd;
  commit;
  pStats('LOG_CAMP_ORBP_PRE_COMP');
